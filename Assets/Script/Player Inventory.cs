    ...
    public bool Removeitem(ItemType itemType, int amount = 1)
    {
        ...
        switch (itemType)
        {
            ...
            case ItemType.Plant:
                if (crystalCount >= amount)      //가지고 있는 개수가 충분한지 확인
                {
                    crystalCount -= amount; //식물 개수 감소
                    Debug.Log($"식물 {amount} 사용! 현재 개수 :{crystalCount}");      //현재 크리스탈 개수 출력
                    return true;
                }
                break;
            case ItemType.Bush:
                ...
                {
                    crystalCount -= amount; //크리스탈 개수 감소
                    Debug.Log($"수풀 {amount} 사용! 현재 개수 :{crystalCount}");      //현재 크리스탈 개수 출력
                    return true;
                }
                break;
            case ItemType.Tree:
                ...
                {
                    crystalCount -= amount; //크리스탈 개수 감소
                    Debug.Log($"나무 {amount} 사용! 현재 개수 :{crystalCount}");      //현재 크리스탈 개수 출력
                    return true;
                }
                break;
        }
    ...
    public void AddItem(ItemType itemtype)
    {
        ...
        switch (itemtype)
        {
            case ItemType.Crystal:
                ...
                Debug.Log($"크리스탈 획스! 현재 개수 :{crystalCount}");           //현재 크리스탈 개수 출력
                break;
            case ItemType.Plant:
                plantCount++;     //식물 개수 증가
                Debug.Log($"식물 획스! 현재 개수 :{plantCount}");           //현재 식물 개수 출력
                break;
            case ItemType.Bush:
                bushCount++;     //수풀 개수 증가
                Debug.Log($"수풀 획스! 현재 개수 :{bushCount}");           //현재 수풀 개수 출력
                break;
            case ItemType.Tree:
                treeCount++;     //크리스탈 개수 증가
                Debug.Log($"나무 획스! 현재 개수 :{treeCount}");           //현재 나무 개수 출력
                break;
        }
    }
